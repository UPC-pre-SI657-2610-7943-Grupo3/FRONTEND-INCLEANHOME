...
.worker-name { font-weight:700; font-size:1rem; color:#1e293b; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
.price-col { text-align:right; flex-shrink:0; }
.price { font-size:1.125rem; font-weight:800; color:#2563eb; }
...
.verified-badge { display:inline-flex; align-items:center; gap:0.25rem; margin-top:0.5rem; background:#d1fae5; color:#065f46; padding:0.2rem 0.5rem; border-radius:9999px; font-size:0.75rem; font-weight:500; }
.services-row { margin-top:0.75rem; }
.info-row { font-size:0.8125rem; color:#64748b; }
...
.btn-outline { border:1px solid #e2e8f0; background:white; }
