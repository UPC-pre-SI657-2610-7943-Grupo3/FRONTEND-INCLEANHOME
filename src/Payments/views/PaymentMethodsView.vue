...
.border-box { border: 1px solid #e2e8f0; }

.card-title { font-weight: 700; color: #1e293b; margin-bottom: 1rem; font-size: 1.25rem; }
...
.mark-default-text { font-size: 0.875rem; font-weight: 500; color: #1e293b; }
